        ...
        <ContentTemplate>
            <div class="h-line">
                ...
                <div class="ca-workflow-form-buttons">
                    ...
                    <asp:Button ID="btnDownload" Text="Download" runat="server" OnClick="btnDownload_Click" OnClientClick="return confirm('By pressing Download, the monthly leave application account will be CLOSED. Are you sure? ');" />
                </div>
            </div>
