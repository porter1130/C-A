...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GroupedTasks.ascx.cs" Inherits="CA.SharePoint.WebControls.WebControls.GroupedTasks" %>
<%@ OutputCache VaryByParam="None" Duration="5" %>
<sp:SPGridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowPaging="False" EnableViewState="false" AllowGrouping="true" AllowGroupCollapse="true" PageSize="3" GroupField="ModuleName" EmptyDataText="you don't have any task.">
