...
{
    public class CALinkToMyApprove2 : BaseSPWebPart
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            hyperLink.NavigateUrl = SPContext.Current.Web.Url + "/" + SPContext.Current.List.Views["All Items"].Url
                + "?FilterField1=ApproversLoginName&FilterValue1=" + HttpUtility.UrlDecode(SPContext.Current.Web.CurrentUser.Name);
