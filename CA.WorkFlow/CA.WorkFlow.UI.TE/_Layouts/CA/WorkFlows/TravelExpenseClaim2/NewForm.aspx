<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" EnableEventValidation="false"
    MasterPageFile="~/_Layouts/CA/Layout.Master" Inherits="CA.WorkFlow.UI.TE.NewForm"
...
<asp:Content ID="Content5" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SetDataViewStyle() {
            $('#<%=this.btnTRNumber.ClientID %>').val('<%=this.Request.QueryString["TRNumber"] %>');
        }
    </script>
</asp:Content>
    ...
    <div id="ca-supplier-form">
        ...
        <QFL:ListFormControl ID="ListFormControl1" runat="server" FormMode="New">
            <div class="ca-workflow-form-buttons noPrint">
                <asp:Button ID="btnTRNumber" Text="TRNumber" runat="server" OnClick="btnTRNumber_Click"
                    CausesValidation="false" />
                <QFC:StartWorkflowButton ID="StartWorkflowButton1" WorkflowName="Travel Expense Claim Workflow"
                    runat="server" Text="Submit" CausesValidation="false" OnClientClick="return CheckSubmit()" />
                <QFC:StartWorkflowButton ID="StartWorkflowButton2" WorkflowName="Travel Expense Claim Workflow"
                    runat="server" Text="Save" CausesValidation="false" OnClientClick="return CheckSubmit()" />
...
<asp:Content ID="Content4" ContentPlaceHolderID="PlaceHolderNotes" runat="server">
    <div class="ca-workflow-form-note noPrint">
        ...
        <div class="middle">
            ...
            will fall back to the Company standard amount.
            <br />
