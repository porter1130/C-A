...
namespace CA.WorkFlow.UI
{
    public static class WorkFlowUtil
    {
        ...
        internal static void BatchInsertDataTable(string listName, string workflowNumber, DataTable dt, Hashtable hash)
        {
            SPList list = WorkFlowUtil.GetWorkflowList(listName);
            string listGuid = list.ID.ToString();
        ...
        internal static DataTable GetDataTableSource(string workflowNumber, string listName, List<string> fieldsList)
        {
