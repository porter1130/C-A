<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveForm.aspx.cs" MasterPageFile="~/_Layouts/CA/Layout.Master"
    Inherits="CA.WorkFlow.UI.PaymentRequest.ApproveForm" %>
            ...
            <tr>
                ...
                <td class="value" id="comment-task">
                    <QFL:TaskPanel runat="server" ID="task1" >
                        <QFL:CommentTaskField runat="server"  ID="CommentTaskField1" CssClass="w490 txtComments" ControlMode="Edit"/>
                    </QFL:TaskPanel>
                </td>
            </tr>
        </table>
        <uc1:DataView ID="PaymentRequestDataView" runat="server" />
