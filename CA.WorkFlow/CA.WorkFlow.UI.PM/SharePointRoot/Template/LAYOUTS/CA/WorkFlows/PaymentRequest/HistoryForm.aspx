<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HistoryForm.aspx.cs" MasterPageFile="~/_Layouts/CA/Layout.Master" 
Inherits="CA.WorkFlow.UI.PaymentRequest.HistoryForm" %>

<%@ Register Src="HistoryView.ascx" TagName="HistoryView" TagPrefix="uc1" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <qfl:listformcontrol id="ListFormControl3" runat="server" formmode="New">
        ...
        <uc1:HistoryView ID="HistoryView1" runat="server" />
     <br />
     <br />
    </qfl:listformcontrol>
</asp:Content>
