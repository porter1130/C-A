namespace CA.WorkFlow.UI.TravelRequest3
{
    ...
    public partial class DataForm : TravelRequest3Control
    {
        ...
        protected void DataBindCostCenter()
        {
            ...
            DataRow dRow = dtCostCenter.NewRow();
            dRow["Display"] = "Please choice ...";
            dRow["Title"] = "";
            dtCostCenter.Rows.InsertAt(dRow, 0);
        ...
        private string validateTravelDetails()
        {
            ...
            for (int i = 0; i < rptTravel.Items.Count; i++)
            {
                ...
                if ((travelDateFrom.IsDateEmpty)
                    ...
                    || string.IsNullOrEmpty(ddlCostCenter.SelectedValue))
                    )
                {
                    status = "Please supply valid travel details.\\n";
                    break;
