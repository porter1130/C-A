...
{
    public partial class UnlockWorkflowWebPartUserControl : UserControl
    {
        ...
        protected void btnUnlock_Click(object sender, EventArgs e)
        {
            ...
            string wfNumber = txtWFNumber.Text;
            string wfAssociationIdStr = ddlWFName.SelectedValue;

            if (wfNumber.IsNotNullOrWhitespace())
            {
                    ...
                    && eventDataItem != null)
                {
                    try
                    {
                        ...
                        CancelWorkflowInstance(workflowItem, wfAssociationIdStr);
        ...
        private void CancelWorkflowInstance(SPListItem workflowItem, string wfAssociationIdStr)
        {
            Guid wfAssociationId = new Guid(wfAssociationIdStr);
