<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Layout.Master" AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI.OSP.NewForm" %>
...
<div id="ca-pr-form">
        <div class="ca-workflow-form-buttons">
            <QFC:StartWorkflowButton ID="StartWorkflowButtonSubmit" WorkflowName="OSP Workflow" runat="server" Text="Submit" CausesValidation="false"/>
            <QFC:StartWorkflowButton ID="StartWorkflowButtonSave" WorkflowName="OSP Workflow" runat="server" Text="Save" CausesValidation="false"/>
