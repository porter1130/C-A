<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataEdit.ascx.cs" Inherits="CA.WorkFlow.UI.NTSC.DataEdit" %>
...
<table class="ca-workflow-form-table" id="TitleTable">
    ...
    <tr>
        ...
        <td class="label align-center" >
            <div>
                <input id="txtSupplierName" runat="server" style="width: 90%; text-align: left" /></div>
            <div style="display: none">
                <asp:DropDownList ID="dpSubDivision" runat="server" Visible="false">
                    <asp:ListItem Text="" Value=""></asp:ListItem>
                </asp:DropDownList>
                <asp:Label ID="lblSubDivision" runat="server"></asp:Label></div>
        </td>
        <td class="label align-center">
            Is Mondial Supplier
        </td>
    ...
    <tr>
        ...
        <td class="pftd value" colspan="3">
            <a href="Tem/Blank Supplier profile - 2011 9 8.xls" target="_blank">Blank Supplier profile
                - 2011 9 8.xls</a><br /><br /><a href="Tem/Garment Supplier assessment audit form 5 Dec 11-.doc"
                    target="_blank">Garment Supplier assessment audit form 5 Dec 11-.doc</a>
        </td>
    </tr>
</table>
