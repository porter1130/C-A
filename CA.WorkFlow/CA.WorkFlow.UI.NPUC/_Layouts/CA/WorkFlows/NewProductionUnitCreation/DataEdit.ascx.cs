...
namespace CA.WorkFlow.UI.NPUC
{
    public partial class DataEdit : BaseWorkflowUserControl
    {
        ...
        public string SupplierNo
        {
            set
            {
                this.txtSupplierNo.Value = value;
            }
            get
            {
                return this.txtSupplierNo.Value.Trim();
            }
        }
        ...
        public string PUNO
        {
            set
            {
                this.txtPUNO.Value = value;
            }
            get
            {
                return this.txtPUNO.Value.Trim();
            }
        }
        ...
        public string ProductionUnitName
        {
            set
            {
                this.txtProductionUnitName.Value = value;
            }
            get
            {
                return this.txtProductionUnitName.Value.Trim();
            }
        }
