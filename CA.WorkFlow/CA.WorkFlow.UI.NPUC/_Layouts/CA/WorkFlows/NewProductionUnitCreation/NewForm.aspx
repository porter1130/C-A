<%@ Page Language="C#" MasterPageFile="~/_Layouts/CA/Layout.Master" AutoEventWireup="true"
    CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI.NPUC.NewForm" Title="New Production Unit Creation" %>
        ...
        <div class="ContentDiv">
            ...
            <QFL:ListFormControl ID="ListFormControl1" runat="server" FormMode="New">
                <div class="ca-workflow-form-buttons noPrint">
                    <QFC:StartWorkflowButton ID="StartWorkflowButton1" WorkflowName="New Production Unit Creation"
                        runat="server" Text="Submit" OnClientClick="return CheckSubmit()" />
                    <QFC:StartWorkflowButton ID="StartWorkflowButton2" WorkflowName="New Production Unit Creation"
