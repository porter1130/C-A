<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserInfo.ascx.cs" Inherits=" CA.WorkFlow.UI.Accelerator.UserInfo" %>
...
<table id="table_comment" class="ca-workflow-form-table full-width">
        <tr>
            ...
            <td class="value" id="comment-task">
                <QFL:FormField ID="CommentsField" runat="server" FieldName="Remarks" ControlMode="Edit" ></QFL:FormField>
            </td>
        </tr>
</table>
<br />
