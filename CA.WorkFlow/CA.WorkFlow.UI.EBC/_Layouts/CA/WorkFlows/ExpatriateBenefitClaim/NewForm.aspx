<%@ Page Language="C#" MasterPageFile="~/_Layouts/CA/Layout.Master" AutoEventWireup="true"
    CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI.EBC.NewForm" Title="Expatriate Benefit Claim Form" %>
        ...
        <div class="ContentDiv">
            ...
            <QFL:ListFormControl ID="ListFormControl1" runat="server" FormMode="New">
                <div class="ca-workflow-form-buttons noPrint">
                    <QFC:StartWorkflowButton ID="StartWorkflowButton1" WorkflowName="Expatriate Benefit Claim Workflow"
                        runat="server" Text="Submit" OnClientClick="return CheckSubmit()" />
                    <QFC:StartWorkflowButton ID="StartWorkflowButton2" WorkflowName="Expatriate Benefit Claim Workflow"
