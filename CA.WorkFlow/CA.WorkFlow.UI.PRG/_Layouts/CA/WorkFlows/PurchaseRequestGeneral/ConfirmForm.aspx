<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Layout.Master" AutoEventWireup="true" CodeBehind="ConfirmForm.aspx.cs" Inherits=" CA.WorkFlow.UI.PurchaseRequestGeneral.ConfirmForm" %>
...
<QFL:ListFormControl ID="ListFormControl3" runat="server" FormMode="Edit">
            ...
            <uc1:DataView ID="DataView1" runat="server" ControlMode="Display" />
