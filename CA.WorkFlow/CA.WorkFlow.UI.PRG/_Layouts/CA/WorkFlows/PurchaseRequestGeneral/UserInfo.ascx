<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserInfo.ascx.cs" Inherits=" CA.WorkFlow.UI.PurchaseRequestGeneral.UserInfo" %>
...
<table id="table_comment" class="ca-workflow-form-table full-width">
        <tr>
            ...
            <td class="value" id="comment-task">
                <QFL:FormField ID="CommentsField" runat="server" FieldName="Comments" ControlMode="Edit" ></QFL:FormField>
            </td>
        </tr>
</table>
<br />
<table id="DataEditUserInfotb" class="ca-workflow-form-table">
    ...
    <tr> <td class="label align-center w25" style="width:200px;">申请人<br />
        ...
        <td class="label align-center w20" >
            <QFL:FormField ID="ApplicantField" runat="server" FieldName="Applicant" ControlMode="Edit"  ></QFL:FormField>
        </td>
        <td class="label align-center w22" style="width:120px;">部门<br />Dept
        </td>
        <td class="label align-center w20">
            <QFL:FormField ID="DepartmentField" runat="server" FieldName="Department" ControlMode="Edit"  ></QFL:FormField>
        </td>
        </tr>
</table>
