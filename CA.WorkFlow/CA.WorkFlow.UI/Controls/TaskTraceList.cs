    ...
    public class TaskTraceList : SPGridView
    {
                ...
                if (tasks != null)
                {
                    ...
                    foreach (DataRow r in tasks.Rows)
                    {
                        if (r["Status"].ToString() == "Completed")
                        {
                            ...
                            string sDueDate = r["DueDate"] == null ? string.Empty : r["DueDate"].ToString().Trim();
        ...
        DataTable GetTasks()
        {
            ...
            if (t != null)
            {
                ...
                t.Columns.Add(WorkflowConstants.Field_WorkflowStep);
                ...
                for (int i = 0; i < t.Rows.Count; i++)
                {
                    ...
                    r[WorkflowConstants.Field_WorkflowStep] = task.Step;
