    ...
    public partial class DataEdit : NonTradeSupplierSetupMaintenanceControl
    {
        ...
        public override bool Validate()
        {
            ...
            else
            {
                ...
                if (vendor != null && vendor["Record Type"].AsString().Equals("Block Request", StringComparison.CurrentCultureIgnoreCase))
                {
                    if (!this.RecordType.Equals("Release Request", StringComparison.CurrentCultureIgnoreCase))
                    {
                        msg = "The filled supplier is blocked, please release it first.";
                        return false;
                    }
                }
