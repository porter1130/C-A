<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/_Layouts/CA/Application.Master"
    CodeBehind="ApproveForm.aspx.cs" Inherits="CA.WorkFlow.UI._Layouts.CA.WorkFlows.SupplierReinspection2.ApproveForm" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <QFL:TaskPanel runat="server" ID="TaskPanel1">
                                    <QFL:CommentTaskField runat="server" ID="ctfComments" ControlMode="Edit"/>
                                </QFL:TaskPanel>
                            </td>
                        </tr>
                        <tr>
