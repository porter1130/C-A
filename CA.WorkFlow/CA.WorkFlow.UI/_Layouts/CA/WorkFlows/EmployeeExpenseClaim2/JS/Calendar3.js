...
Calendar.language = {
	...
	"date2StringPattern" : ["M-d-yyyy", "M-d-yyyy", "M-d-yyyy", "M-d-yyyy"],
...
Calendar.prototype.draw = function() {
	...
	_cs[_cs.length] = '<table id="__calendarTable" width="100%" border="0" cellpadding="3" cellspacing="1" align="center" style="cursor:pointer" >';
	_cs[_cs.length] = ' <tr>';
	...
	_cs[_cs.length] = ' <tr>';
	_cs[_cs.length] = '  <th colspan="2"><input style="cursor:pointer" type="button" class="b" name="clearButton" id="clearButton" \/><\/th>';
	_cs[_cs.length] = '  <th colspan="3"><input style="cursor:pointer" type="button" class="b" name="selectTodayButton" id="selectTodayButton" \/><\/th>';
	_cs[_cs.length] = '  <th colspan="2"><input style="cursor:pointer" type="button" class="b" name="closeButton" id="closeButton" \/><\/th>';
	_cs[_cs.length] = ' <\/tr>';
