<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataListEdit.ascx.cs"
    Inherits="CA.WorkFlow.UI.EmployeeExpenseClaim2.DataListEdit" %>
                                ...
                                <div class="ExpenseType1">
                                    <asp:DropDownList ID="ddlExpenseType" runat="server" CssClass="ExpenseType" onchange="ChangeGLAccount(this)" >
                                       ...
                                       <asp:ListItem Text="Consulting others" Value="Consulting others"></asp:ListItem>
                                        ...
                                        <asp:ListItem Text="Wireless/Mobile" Value="Wireless/Mobile"  />
                                        ...
                                        <asp:ListItem Text="Store mgnt exp - Wireless/Mobile" Value="Store mgnt exp - Wireless/Mobile"></asp:ListItem>
