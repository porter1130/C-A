<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Layout.Master" AutoEventWireup="true"
    CodeBehind="EditForm.aspx.cs" Inherits="CA.WorkFlow.UI.CreditCardClaim.EditForm" %>
    ...
    <div id="ca-supplier-form">
        ...
        <QFL:ListFormControl ID="ListFormControl1" runat="server" FormMode="New">
            <div class="ca-workflow-form-buttons noPrint">
                <cc1:CAActionsButton ID="Actions" runat="server" CausesValidation="true" OnClientClick="return CheckClaim()" />
                <asp:Button runat="server" ID="btnSave" Text="Save" CausesValidation="false"  OnClientClick="return CheckClaim()" />
