<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataListSAPView.ascx.cs"
    Inherits="CA.WorkFlow.UI.CreditCardClaim.DataListSAPView" %>
...
<table border="0" cellpadding="0" cellspacing="0" id="tb_summary">
    <tr>
        <td colspan="3">
            <h3>
                Credit Card Claim Sap Details</h3>
        </td>
    </tr>
    <tr>
       <td style="font-weight: bold; width: 250px">
            <input type="checkbox" class="ckAll" title="Select All Items" />　　Credit Card Claim Form ID
        </td>
        <td style="padding-left: 26px; font-weight: bold; width: 300px">
            Credit Card Claim WorkFlowNumber
        </td>
            ...
            <tr class="wftr">
                  <td class="td_check" >
                    <img src="../images/pixelicious_001.png" alt="Expand Detail Items" align="absmiddle"
                        onclick="DisplayDetails(this)" /><input type="checkbox" name="chkitem" title='<%#Eval("CCCWWorkflowNumber") %>' id='<%#Eval("Title") %>'
                          class="itemCK" /> <span class="span_wftitle"><%#Eval("Title") %></span>
                  </td>
                <td style="padding-left: 26px">
                    <%# Eval("CCCWWorkflowNumber")%>
                </td>
