<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataView.ascx.cs" Inherits="CA.WorkFlow.UI.TravelRequest3.DataView" %>
...
<table class="ca-workflow-form-table">
    ...
    <tr class="tr_sapnosection hidden last">
        ...
        <td class="value align-center sapnumber">
            <QFL:FormField ID="ffSapNumber" runat="server" FieldName="SAPNumber" ControlMode="Display">
            </QFL:FormField>
        </td>
    </tr>
</table>
            ...
            <table id="ca-travel-detail" class="inner-table">
                ...
                <tr>
                    <td colspan="6">
                        <table class="inner-table">
                            <tr>
                                <td colspan="7" class="value align-right">
                                </td>
                            </tr>
                            <tr>
                ...
                <tr>
                    ...
                    <td class="cashadvance">
                        ...
                        <div id="ca-travel-cashadvance">
                            <span style="display: none;">N/A</span> <span>
