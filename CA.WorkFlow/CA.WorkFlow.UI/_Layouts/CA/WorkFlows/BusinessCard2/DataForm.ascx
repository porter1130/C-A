<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataForm.ascx.cs" Inherits="CA.WorkFlows.BusinessCard2.DataForm" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="workflow_table3">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtCompanyCN" runat="server" Width="95%" CssClass="input_ts4" Text="西雅衣家(中国)商业有限公司"></asp:TextBox>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtCompanyEN" runat="server" Width="95%" CssClass="input_ts4" Text="C&amp;A (China) Co., Ltd."></asp:TextBox>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="workflow_table3">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtAddrChi" runat="server" CssClass="input_ts4" Text="上海市延安西路2299号,上海世贸商城3A88室"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            <asp:TextBox ID="txtAddr" runat="server" CssClass="input_ts4" Text="3A88 Shanghai Mart,2299 Yan'an Road West"></asp:TextBox>
        </td>
    </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="workflow_table3">
