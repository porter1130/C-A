...
namespace CA.WorkFlows.BusinessCard2
{
    public partial class NewForm : CAWorkFlowPage
    {
        ...
        void StartWorkflowButton1_Executing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            Employee managerEmp = CurrentEmployee;
            ...
            else
            {
                ...
                //HRManager = UserProfileUtil.GetDepartmentManager("Human Resources");
                managerEmp = GetNextApprover(this.DataForm1.Applicant);
            ...
            try
            {
                ...
                //原审批人
                NameCollection accounts = WorkFlowUtil.GetUsersInGroup("wf_Reception");
                //设置工作流步骤及对应原始审批人
                ...
                WorkflowContext.Current.UpdateWorkflowVariable(CA.WorkFlow.UI.Constants.WorkFlowStep.BusinessCardDDepartmentHeadApprove_User, GetDelemanNameCollection(new NameCollection(managerEmp.UserAccount), CA.WorkFlow.UI.Constants.CAModules.BusinessCardApplication));
