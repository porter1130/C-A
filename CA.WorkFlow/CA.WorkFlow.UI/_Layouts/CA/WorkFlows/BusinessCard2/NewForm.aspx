<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Application.Master"
    AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlows.BusinessCard2.NewForm" %>
                ...
                <table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="workflow_table_button"  style="padding-bottom:10px">
                             ...
                             <QFC:StartWorkflowButton ID="StartWorkflowButton1" runat="server" Text="Submit"   WorkflowName="Business Card Application2"/>
                             <QFC:StartWorkflowButton ID="StartWorkflowButton2" runat="server" Text="Save"  WorkflowName="Business Card Application2"/>
