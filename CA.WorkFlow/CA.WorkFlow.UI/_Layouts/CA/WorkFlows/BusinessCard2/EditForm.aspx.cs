...
namespace CA.WorkFlows.BusinessCard2
{
    public partial class EditForm : CAWorkFlowPage
    {
        ...
        void actions_ActionExecuting(object sender, QuickFlow.UI.Controls.ActionEventArgs e)
        {
            ...
            AddWorkFlowStepApprovers(WorkflowContext.Current.Task.Step, CA.WorkFlow.UI.Constants.WorkFlowStep.BusinessCardApprovers, CA.WorkFlow.UI.Constants.WorkFlowStep.BusinessCardApproverLoginName);
            if (WorkflowContext.Current.Task.Step == CA.WorkFlow.UI.Constants.WorkFlowStep.BusinessCardDDepartmentHeadApprove)
            {
