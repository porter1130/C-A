<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Application.Master"
    AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI.SupplierReticketing2.NewForm" %>
            ...
            <tr>
                <td>
                    <div class="workflow_table_button" style="padding-bottom: 10px">
                        <QFC:StartWorkflowButton ID="StartWorkflowButton1" runat="server" Text="Submit"  WorkflowName="Supplier Reticketing Workflow2" />
                        <QFC:StartWorkflowButton ID="StartWorkflowButton2" runat="server" Text="Save"   WorkflowName="Supplier Reticketing Workflow2" />
