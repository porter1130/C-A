<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Application.Master"
    AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI.TimeOff2.NewForm" %>
                    ...
                    <table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="workflow_table_button" style="padding-bottom: 10px">
                                <CAControls:CAStartWFButton ID="StartWorkflowButton1" runat="server" Text="Submit"  WorkflowName="Leave Application Workflow3"/>
                                <CAControls:CAStartWFButton ID="StartWorkflowButton2" runat="server" Text="Save" WorkflowName="Leave Application Workflow3" 
