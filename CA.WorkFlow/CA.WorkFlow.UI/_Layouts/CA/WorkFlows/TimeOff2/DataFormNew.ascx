<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataFormNew.ascx.cs" Inherits="CA.WorkFlow.UI.TimeOff2.DataFormNew" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="1" class="workflow_table3">
    <tr>
        ...
        <td>
            ...
            <QFL:FormField ID="formFieldNumber" runat="server" FieldName="WorkFlowNumber" >
            </QFL:FormField>
        </td>
    </tr>
</table>
<table runat="server" id="tableDisplay" width="100%" border="0" cellpadding="0" cellspacing="1"
    ...
    <tr>
        ...
        <td width="24%">
            <QFL:FormField ID="formFieldApplicant" runat="server" FieldName="Applicant" >
            </QFL:FormField>
        </td>
        <th width="28%">
            Department 部门:
        ...
        <td width="24%">
            <QFL:FormField ID="formFieldDeptment" runat="server" FieldName="Department" >
            </QFL:FormField>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <QFL:FormField ID="formFieldJobTitle" runat="server" FieldName="JobTitle" >
            </QFL:FormField>
        </td>
        <th>
            Employee NO 员工编号:
        ...
        <td>       
            <QFL:FormField ID="formFieldEmployeeID" runat="server" FieldName="EmployeeID" >
            </QFL:FormField>
        </td>
    </tr>
</table>
