<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiTable.ascx.cs" Inherits="CA.WorkFlow.UI.TimeOff2.MultiTable" %>
            ...
            <asp:Repeater ID="RepeaterEdit" runat="server" OnItemCommand="RepeaterEdit_ItemCommand" OnItemDataBound="RepeaterEdit_ItemDataBound">
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtDays" Width="25px" ></asp:TextBox>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
