...
namespace CA.WorkFlow.UI.TimeOff2
{
    public partial class CancelApproveForm : CAWorkFlowPage
    {
        ...
        void actions_ActionExecuting(object sender, QuickFlow.UI.Controls.ActionEventArgs e)
        {
            ...
            {
                case CA.WorkFlow.UI.Constants.WorkFlowStep.TimeOffWorkCancelDepartmentHeaderApprove:
                    QuickFlow.NameCollection hrAccounts = WorkFlowUtil.GetUsersInGroup("wf_HR");
                    ...
                    break;
                case CA.WorkFlow.UI.Constants.WorkFlowStep.TimeOffWorkCancelHRReview:
                    string strHRHeadAccount = UserProfileUtil.GetDepartmentManager("Human Resources");
                    WorkflowContext.Current.UpdateWorkflowVariable(CA.WorkFlow.UI.Constants.WorkFlowStep.TimeOffHRHeadAccount, GetDelemanNameCollection(new QuickFlow.NameCollection(strHRHeadAccount), Constants.CAModules.LeaveApplication));
                    break;
            }
