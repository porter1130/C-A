<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/_Layouts/CA/Application.Master"
    CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI.NewStoreBudgetApplication2.NewForm" %>
            ...
            <tr>
                <td>
                    <div class="workflow_table_button" style="padding-bottom: 10px">
                        <CAControls:CAStartWFButton ID="StartWorkflowButton1" OnClientClick="return CheckValue()" runat="server" Text="Submit"  WorkflowName="New Store Construction Budget Workflow2"/>
                        <CAControls:CAStartWFButton ID="StartWorkflowButton2" runat="server" Text="Save" WorkflowName="New Store Construction Budget Workflow2" />
