<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Layout.Master" AutoEventWireup="true"
    CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI.CashAdvanceRequest.NewForm"
    ...
    <div id="ca-supplier-form">
        ...
        <QFL:ListFormControl ID="ListFormControl1" runat="server" FormMode="New">
            <div class="ca-workflow-form-buttons noPrint">
                <QFC:StartWorkflowButton ID="StartWorkflowButton1" WorkflowName="CashAdvanceClaimWorkFlow1"
                    runat="server" Text="Submit" OnClientClick="return CheckInfo()" />
                <QFC:StartWorkflowButton ID="StartWorkflowButton2" WorkflowName="CashAdvanceClaimWorkFlow1"
                    runat="server" Text="Save" CausesValidation="false" OnClientClick="return CheckInfo()"/>
