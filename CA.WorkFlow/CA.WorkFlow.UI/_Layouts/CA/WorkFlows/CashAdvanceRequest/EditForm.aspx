<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Layout.Master" AutoEventWireup="true"
    CodeBehind="EditForm.aspx.cs" Inherits="CA.WorkFlow.UI.CashAdvanceRequest.EditForm"
    ...
    <div id="ca-supplier-form">
        ...
        <QFL:ListFormControl ID="ListFormControl1" runat="server" FormMode="New">
            <div class="ca-workflow-form-buttons noPrint">
                <cc1:CAActionsButton ID="Actions" runat="server" CausesValidation="true" OnClientClick="return CheckInfo()"/>
                <asp:Button runat="server" ID="btnSave" Text="Save" CausesValidation="false"  OnClientClick="return CheckInfo()" />
                <input type="button" value="Back" onclick="window.location.href = '/WorkFlowCenter/Lists/Tasks/MyItems.aspx';" />
            </div>
            <uc1:DataForm ID="DataForm1" runat="server" RequireValidation="true" ControlMode="Edit"/>
