<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SelectVendor.ascx.cs" Inherits="CA.WorkFlow.UI.NonTradeSupplierSetupMaintenance2.SelectVendor" %>
        ...
        <ContentTemplate>
            ...
            <script type="text/javascript">
                ...
                function EndRequestHandler() {
                    $('#<%= this.SPGridView1.ClientID %> tr').click(function () {
                        $(this).siblings().removeClass('selected');
                        $(this).addClass('selected');
                        $('#<%= this.hidSelectedWorkflowNumber.ClientID %>').val($(this).find('td:first').text());
                    });

                    $('#<%= this.SPGridView1.ClientID %> tr').hover(function () {
                        $(this).toggleClass('hover');
                    });
                }
            </script>
