<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataEdit.ascx.cs" Inherits="CA.WorkFlow.UI.NonTradeSupplierSetupMaintenance2.DataEdit" %>
...
<div id="ca-workflow-non-trade">
                ...
                <table class="inner-table">
                    <tr>
                        <td class="label align-center w15">
                            中文<span class="clr-red icon-point">●</span>
                        </td>
                        <td class="value">
                    ...
                    <tr>
                        <td class="label align-center">
                            English<span class="clr-red icon-point">●</span>
                        </td>
                        <td class="value">
    ...
    <table class="ca-workflow-form-table full-width">
        ...
        <tr>
            <td class="label align-center w25">
                Company Telephone No.<span class="clr-red icon-point">●</span>
            </td>
            <td class="value">
    ...
    <table class="ca-workflow-form-table full-width">
        ...
        <tr>
            <td class="label align-center w25">
                Last Name<span class="clr-red icon-point">●</span>
            </td>
            <td class="label align-center w25">
            ...
            <td class="label align-center w25">
                First Name<span class="clr-red icon-point">●</span>
            </td>
            <td class="value">
        ...
        <tr>
            ...
            <td class="label align-center w25">
                Department<span class="clr-red icon-point">●</span>
            </td>
            <td class="value">
        ...
        <tr class="last">
            <td class="label align-center w25">
                Phone No.<span class="clr-red icon-point">●</span>
            </td>
            <td class="label align-center w25">
    ...
    <table class="ca-workflow-form-table full-width">
        ...
        <tr>
            <td class="label align-center w25">
                Payment Term<span class="clr-red icon-point">●</span>
                <br />
        ...
        <tr class="last">
            <td class="label align-center w25">
                Currency<span class="clr-red icon-point">●</span>
            </td>
    ...
    <table class="ca-workflow-form-table full-width">
        ...
        <tr>
            <td class="label align-center w25">
                Business License No.<span class="clr-red icon-point">●</span>
            </td>
            <td class="label align-center w25">
            ...
            <td class="label align-center w25">
                Tax Registration License No.<span class="clr-red icon-point">●</span>
            </td>
            <td class="value">
        ...
        <tr>
            <td class="label align-center w25">
                Name of Bank<span class="clr-red icon-point">●</span>
            </td>
            <td class="label align-center w25">
        ...
        <tr>
            ...
            <td class="label align-center w25">
                Country of Bank<span class="clr-red icon-point">●</span>
            </td>
            <td class="value">
        ...
        <tr>
            <td class="label align-center w25">
                Bank Key<span class="clr-red icon-point">●</span>
            </td>
            <td class="label align-center w25">
        ...
        <tr class="last">
            <td class="label align-center w25">
                Bank Account No.<span class="clr-red icon-point">●</span>
            </td>
            <td class="label align-center w25">
    ...
    <table class="ca-workflow-form-table full-width" id="tblChangeReason" runat="server">
        <tr>
            <td colspan="2" class="label align-center w25">
                Reason for <span class="change-type">Change</span> 
            </td>
        </tr>
        <tr>
            <td class="label w25 align-center">
...
<script type="text/javascript">
    ...
    $('#ca-workflow-non-trade input:radio').change(function (event) {
        if ($(this).val() === 'ctl00') {
            ...
            $('#ca-supplier-form .icon-point').removeClass('hidden');
        }
        else {
            ...
            $('#ca-supplier-form .icon-point').addClass('hidden');
            ...
            switch (label) {
                ...
                case 'Release Request':
                    type = label + '<br />解除冻结原因';
                    break;
                default:
                    type = label;
                    break;
            }
            $('#<%= this.tblChangeReason.ClientID %> .change-type').html(type);
        }
    ...
    $(function () {
        ...
        var label = $('#ca-workflow-non-trade input:checked').next('label').html();
        var type = '';
        switch (label) {
            case 'Change Request':
                type = label + '<br />变更原因';
        ...
        $('#<%= this.tblChangeReason.ClientID %> .change-type').html(type);
        $('#ca-workflow-non-trade input:text').keyup(function (event) {
            $(this).attr('changed', 'true');
        });
        $('#ca-workflow-non-trade select').keyup(function (event) {
            $(this).attr('changed', 'true');
        });
    });
    ...
    function updateValues(sender) {
        var isChange = $('#ca-workflow-non-trade input:checked').next('label').html() === 'Change Request';
        $('#ca-workflow-non-trade input:text').each(function (event) {
            if ((isChange && $(this).attr('changed') != 'true') || !isChange) {
    ...
    function SetPaymentTerm() {
        var Payment_Term=$('#<%=this.Payment_Term.ClientID%>_ctl00_ctl00_TextField');
        if (Payment_Term.val() != "0") {
            Payment_Term.val("");
        }
    }
    ...
    function validate() {
        ...
        if (type === 'ctl00') {
            ...
            if (ca.util.emptyString($('#<%=this.Bank_Key.ClientID%>_ctl00_ctl00_TextField').val())) {
                error += '- Please fill in the Bank Key field.\n';
            }
            ...
            if (ca.util.emptyString($('#<%=this.Reason_For_Change.ClientID%>_ctl00_ctl00_TextField').val())) {
                error += '- Please fill in the Reason For ' + $('#ca-workflow-non-trade input:checked').next('label').html() + ' field.\n';
            }
        }
