<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveForm.aspx.cs" MasterPageFile="~/_Layouts/CA/Layout.Master" Inherits="CA.WorkFlow.UI.CreationOrder2.ApproveForm" %>
...
<asp:Content ID="Content9" ContentPlaceHolderID="PlaceHolderNotes" runat="server">
    <div class="ca-workflow-form-note noPrint">
        <div class="top">
            &nbsp;</div>
        <div class="middle">
            *If Project Control exceeds the annual budget, please forward to CFO for approval
        </div>
        <div class="foot">
            &nbsp;</div>
    </div>
