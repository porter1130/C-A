<%@ Page Language="C#" MasterPageFile="~/_Layouts/CA/Application.Master" AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI._Layouts.CA.WorkFlows.StoreSampling2.NewForm" %>
                    ...
                    <table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="workflow_table_button"  style="padding-bottom:10px">
                                <QFC:StartWorkflowButton ID="StartWorkflowButton1" runat="server" Text="Submit" OnClientClick="return validForm();"  WorkflowName="Store Sampling Workflow2" />
                                <QFC:StartWorkflowButton ID="StartWorkflowButton2" runat="server" Text="Save"  WorkflowName="Store Sampling Workflow2" />
