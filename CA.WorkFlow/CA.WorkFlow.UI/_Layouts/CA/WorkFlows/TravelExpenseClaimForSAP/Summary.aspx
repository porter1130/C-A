<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" MasterPageFile="~/_Layouts/CA/Layout.Master"
 Inherits="CA.WorkFlow.UI.TravelExpenseClaimForSAP.Summary" %>
...
<%@ Register Src="DataSummary.ascx" TagName="DataForm" TagPrefix="uc1" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <QFL:ListFormControl ID="ListFormControl1" runat="server" FormMode="New">
            <div class="ca-workflow-form-buttons noPrint">
                <asp:Button ID="btnPostToSAP" runat="server" OnClientClick="javascript:CreateForbidDIV();" OnClick="btnPostToSAP_Click" 
                    Text="Post To SAP" />        
                <input type="button" value="Back" onclick="location.href = 'WorkFlowCenter/Lists/TravelExpenseClaimForSAP/'" />
            </div>
