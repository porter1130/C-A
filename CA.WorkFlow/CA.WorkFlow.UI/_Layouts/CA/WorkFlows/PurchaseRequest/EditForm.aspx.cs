namespace CA.WorkFlow.UI.PurchaseRequest
{
    ...
    public partial class EditForm : CAWorkFlowPage
    {
        ...
        private void CheckSecurity()
        {
            ...
            if (SecurityValidate(uTaskId, uListGUID, uID, false) || PurchaseRequestCommon.isAdmin())
            {
        ...
        private void CheckAccount()
        {
            ...
            else if (PurchaseRequestCommon.IsHO(current) || PurchaseRequestCommon.isAdmin())
            {
        ...
        private void SaveAction(object sender, ActionEventArgs e)
        {
                ...
                PurchaseRequestCommon.SaveDetails(this.DataForm1, fields["WorkflowNumber"].AsString(), capexType, requestType, isHO, itemIdentity); //Save request details to lists

                //fields["Total"] = float.Parse(DataForm1.Total);
                fields["TotalRMB"] = DataForm1.TotalRMB;
                fields["ApprovalTotalRMB"] = DataForm1.ApprovalTotalRMB;
