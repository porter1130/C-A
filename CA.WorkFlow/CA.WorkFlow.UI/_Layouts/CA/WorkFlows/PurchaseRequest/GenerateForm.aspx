<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenerateForm.aspx.cs" 
MasterPageFile="~/_Layouts/CA/Layout.Master" Inherits="CA.WorkFlow.UI.PurchaseRequest.GenerateForm" %>

<%@ Register Assembly="CA.WorkFlow.UI" Namespace="CA.WorkFlow.UI" TagPrefix="cc1" %>
<%@ Register Src="DataList.ascx" TagName="DataForm" TagPrefix="uc1" %>
