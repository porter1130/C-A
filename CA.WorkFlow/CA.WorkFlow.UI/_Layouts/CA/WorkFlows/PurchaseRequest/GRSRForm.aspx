<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRSRForm.aspx.cs" 
MasterPageFile="~/_Layouts/CA/Layout.Master" Inherits="CA.WorkFlow.UI.PurchaseRequest.GRSRForm" %>

<%@ Register Assembly="CA.WorkFlow.UI" Namespace="CA.WorkFlow.UI" TagPrefix="cc1" %>
<%@ Register Src="DataGRSR.ascx" TagName="DataForm" TagPrefix="uc1" %>
