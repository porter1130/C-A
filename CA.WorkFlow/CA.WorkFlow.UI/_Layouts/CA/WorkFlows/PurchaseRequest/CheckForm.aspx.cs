namespace CA.WorkFlow.UI.PurchaseRequest
{
    ...
    public partial class CheckForm : CAWorkFlowPage
    {
        ...
        private void Actions_ActionExecuting(object sender, ActionEventArgs e)
        {
            ...
            if (e.Action.Equals("Confirm", StringComparison.CurrentCultureIgnoreCase))
            {
                ...
                PurchaseRequestCommon.SaveDetails(this.DataForm1, fields["WorkflowNumber"].AsString(), DataForm1.CapexType, DataForm1.RequestType, isHO, itemIdentity); 
