                    ...
                    <table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="workflow_table_button"  style="padding-bottom:10px">
                                <QFC:StartWorkflowButton ID="StartWorkflowButton1" runat="server" Text="Submit" OnClientClick="return validForm();"  WorkflowName="StoreSamplingWorkflow"/>
                                <QFC:StartWorkflowButton ID="StartWorkflowButton2" runat="server" Text="Save"  WorkflowName="StoreSamplingWorkflow" />
