...
%STSADM% -o deactivatefeature -name TravelRequestWorkflow -url %WFSITE%
%STSADM% -o deactivatefeature -name PurchaseRequestWorkflow -url %WFSITE%
%STSADM% -o deactivatefeature -name PurchaseOrderWorkflow -url %WFSITE%
%STSADM% -o deactivatefeature -name CommonItemCodes -url %WFSITE%
echo End
...
%STSADM% -o uninstallfeature -name TravelRequestWorkflow -force
%STSADM% -o uninstallfeature -name PurchaseRequestWorkflow -force
%STSADM% -o uninstallfeature -name PurchaseOrderWorkflow -force
%STSADM% -o uninstallfeature -name CommonItemCodes -force
echo End
...
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\_Layouts\CAResources\themeCA\*" "%TEMPLATE%\LAYOUTS\CAResources\themeCA\"
echo End
...
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\_Layouts\CA\WorkFlows\TravelRequest2\*.aspx" "%TEMPLATE%\LAYOUTS\CA\WorkFlows\TravelRequest2\"
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\_Layouts\CA\WorkFlows\TravelRequest2\*.ascx" "%TEMPLATE%\LAYOUTS\CA\WorkFlows\TravelRequest2\"
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\_Layouts\CA\WorkFlows\PurchaseRequest\*.aspx" "%TEMPLATE%\LAYOUTS\CA\WorkFlows\PurchaseRequest\"
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\_Layouts\CA\WorkFlows\PurchaseRequest\*.ascx" "%TEMPLATE%\LAYOUTS\CA\WorkFlows\PurchaseRequest\"
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\_Layouts\CA\WorkFlows\PurchaseOrder\*.aspx" "%TEMPLATE%\LAYOUTS\CA\WorkFlows\PurchaseOrder\"
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\_Layouts\CA\WorkFlows\PurchaseOrder\*.ascx" "%TEMPLATE%\LAYOUTS\CA\WorkFlows\PurchaseOrder\"
...
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\Features\TravelRequestWorkflow\*" "%TEMPLATE%\FEATURES\TravelRequestWorkflow\"
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\Features\PurchaseRequestWorkflow\*" "%TEMPLATE%\FEATURES\PurchaseRequestWorkflow\"
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\Features\PurchaseOrderWorkflow\*" "%TEMPLATE%\FEATURES\PurchaseOrderWorkflow\"
xcopy /s /Y /C /R "%WFSOURCE%\CA.WorkFlow.UI\Features\CommonItemCodes\*" "%TEMPLATE%\FEATURES\CommonItemCodes\"
echo End
...
%STSADM% -o installfeature -name TravelRequestWorkflow
%STSADM% -o installfeature -name PurchaseRequestWorkflow
%STSADM% -o installfeature -name PurchaseOrderWorkflow
%STSADM% -o installfeature -name CommonItemCodes
echo End
...
%STSADM% -o activatefeature -name TravelRequestWorkflow -url %WFSITE%
%STSADM% -o activatefeature -name PurchaseRequestWorkflow -url %WFSITE%
%STSADM% -o activatefeature -name PurchaseOrderWorkflow -url %WFSITE%
%STSADM% -o activatefeature -name CommonItemCodes -url %WFSITE%
echo End
